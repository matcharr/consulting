...
class NewslettersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create newsletter" do
    assert_difference('Newsletter.count') do
      post newsletters_url, params: { newsletter: { body: @newsletter.body, object: @newsletter.object } }
    end
  ...
  test "should update newsletter" do
    patch newsletter_url(@newsletter), params: { newsletter: { body: @newsletter.body, object: @newsletter.object } }
